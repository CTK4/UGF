export const UI_ID = {
  hub: {
    ...
    staffMeetingButton: "hub.staffMeetingButton",
    teamName: "hub.teamName",
    capSpace: "hub.capSpace",
    ...
    quickLinkPhone: "hub.quickLink.phone",
    quickLinkStaffMeeting: "hub.quickLink.staffMeeting",
    newsPlaceholder: "hub.newsPlaceholder",
  },
  staffMeeting: {
